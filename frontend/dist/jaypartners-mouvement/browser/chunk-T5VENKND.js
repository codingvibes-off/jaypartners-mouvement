...
// src/app/features/auth/inscription.component.ts
function InscriptionComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
...
function InscriptionComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label");
    \u0275\u0275text(1, " Pr\xE9nom ");
    \u0275\u0275elementStart(2, "input", 23);
    \u0275\u0275twoWayListener("ngModelChange", function InscriptionComponent_Conditional_22_Template_input_ngModelChange_2_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
...
function InscriptionComponent_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
...
function InscriptionComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
...
function InscriptionComponent_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
...
var InscriptionComponent = class _InscriptionComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InscriptionComponent, selectors: [["app-inscription"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 35, vars: 9, consts: [[1, "conteneur-auth"], [1, "carte-auth"], [1, "boutons-oauth"], ["type", "button", 1, "btn-oauth", "btn-oauth-google", 3, "click"], ["width", "18", "height", "18", "viewBox", "0 0 18 18", "aria-hidden", "true"], ["d", "M17.64 9.2c0-.64-.06-1.25-.16-1.84H9v3.48h4.84a4.14 4.14 0 0 1-1.8 2.72v2.26h2.9c1.7-1.57 2.7-3.88 2.7-6.62Z", "fill", "#4285F4"], ["d", "M9 18c2.43 0 4.47-.8 5.96-2.18l-2.9-2.26c-.8.54-1.84.86-3.06.86-2.35 0-4.34-1.59-5.05-3.72H.95v2.33A9 9 0 0 0 9 18Z", "fill", "#34A853"], ["d", "M3.95 10.7A5.4 5.4 0 0 1 3.67 9c0-.59.1-1.17.28-1.7V4.97H.95A9 9 0 0 0 0 9c0 1.45.35 2.83.95 4.03l3-2.33Z", "fill", "#FBBC05"], ["d", "M9 3.58c1.32 0 2.5.46 3.44 1.35l2.58-2.58C13.46.89 11.43 0 9 0A9 9 0 0 0 .95 4.97l3 2.33C4.66 5.17 6.65 3.58 9 3.58Z", "fill", "#EA4335"], ["type", "button", 1, "btn-oauth", "btn-oauth-apple", 3, "click"], ["width", "16", "height", "18", "viewBox", "0 0 16 18", "fill", "currentColor", "aria-hidden", "true"], ["d", "M13.1 9.53c-.02-2.02 1.65-2.99 1.72-3.04-.94-1.37-2.4-1.56-2.92-1.58-1.24-.13-2.43.73-3.06.73-.63 0-1.6-.71-2.63-.7-1.35.02-2.6.79-3.3 1.99-1.4 2.44-.36 6.05 1.02 8.03.67.96 1.47 2.05 2.51 2.01 1.01-.04 1.39-.65 2.61-.65 1.21 0 1.56.65 2.62.63 1.08-.02 1.77-.98 2.43-1.95a8.6 8.6 0 0 0 1.09-2.26 3.72 3.72 0 0 1-2.09-3.21Z"], ["d", "M11.06 3.5c.55-.67.92-1.6.82-2.5-.79.03-1.75.53-2.32 1.18-.51.58-.96 1.53-.84 2.44.88.06 1.79-.44 2.34-1.12Z"], [1, "oauth-message"], [1, "separateur"], [3, "ngSubmit"], ["type", "email", "name", "email", "required", "", 3, "ngModelChange", "ngModel"], ["type", "password", "name", "password", "required", "", "minlength", "6", 3, "ngModelChange", "ngModel"], [1, "erreur"], ["type", "submit", 1, "btn-primaire", 3, "disabled"], [1, "lien-alt"], ["routerLink", "/connexion"], ["routerLink", "/inscription"], ["type", "text", "name", "prenom", "required", "", 3, "ngModelChange", "ngModel"]], template: function InscriptionComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function InscriptionComponent_Template_button_click_12_listener() {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(17, InscriptionComponent_Conditional_17_Template, 2, 1, "p", 13);
      \u0275\u0275namespaceHTML();
      \u0275\u0275elementStart(18, "div", 14)(19, "span");
      \u0275\u0275text(20, "ou");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(21, "form", 15);
      \u0275\u0275listener("ngSubmit", function InscriptionComponent_Template_form_ngSubmit_21_listener() {
        return ctx.soumettre();
      });
      \u0275\u0275template(22, InscriptionComponent_Conditional_22_Template, 3, 1, "label");
      \u0275\u0275elementStart(23, "label");
      \u0275\u0275text(24, " Email ");
      \u0275\u0275elementStart(25, "input", 16);
      \u0275\u0275twoWayListener("ngModelChange", function InscriptionComponent_Template_input_ngModelChange_25_listener($event) {
      ...
      \u0275\u0275twoWayListener("ngModelChange", function InscriptionComponent_Template_input_ngModelChange_28_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.password, $event) || (ctx.password = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275template(29, InscriptionComponent_Conditional_29_Template, 2, 1, "p", 18);
      \u0275\u0275elementStart(30, "button", 19);
      \u0275\u0275text(31);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(32, "p", 20);
      \u0275\u0275template(33, InscriptionComponent_Conditional_33_Template, 3, 0, "a", 21)(34, InscriptionComponent_Conditional_34_Template, 3, 0, "a", 22);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InscriptionComponent, { className: "InscriptionComponent" });
})();
export {
  InscriptionComponent
};
//# sourceMappingURL=chunk-T5VENKND.js.map
