...
var TranslateService = class _TranslateService {
  ...
  constructor() {
    ...
    this.parent = config2.isRoot ? null : inject(_TranslateService, {
      optional: true,
      skipSelf: true
    });
...
function provideTranslateService(config2 = {}) {
  return defaultProviders(__spreadProps(__spreadValues({}, config2), {
    isRoot: true
  }));
}
...
function defaultProviders(config2) {
  const providers = [];
  const loader = resolvePluginProvider(TranslateLoader, config2.loader, TranslateNoOpLoader, "loader", "provideTranslateLoader");
  const compiler = resolvePluginProvider(TranslateCompiler, config2.compiler, TranslateNoOpCompiler, "compiler", "provideTranslateCompiler");
  const parser = resolvePluginProvider(TranslateParser, config2.parser, TranslateDefaultParser, "parser", "provideTranslateParser");
  const missingTranslationHandler = resolvePluginProvider(MissingTranslationHandler, config2.missingTranslationHandler, DefaultMissingTranslationHandler, "missingTranslationHandler", "provideMissingTranslationHandler");
...
@angular/core/fesm2022/rxjs-interop.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-M2LWS2MJ.js.map
