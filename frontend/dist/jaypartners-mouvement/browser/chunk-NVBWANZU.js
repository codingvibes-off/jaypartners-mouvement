...
function ContactComponent_For_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(reseau_r1.handle);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(reseau_r1.description);
  }
}
var ContactComponent = class _ContactComponent {
  reseaux = [
    {
      nom: "WhatsApp",
      handle: "Groupe communaut\xE9",
      description: "Rejoins le groupe pour poser tes questions et suivre l'actu des s\xE9ances.",
    ...
    },
    {
      nom: "TikTok",
      handle: "@jaypartner.s",
      description: "Des mouvements et astuces en vid\xE9o courte.",
    ...
    },
    {
      nom: "YouTube",
      handle: "@JAYPARTNERS",
      description: "S\xE9ances compl\xE8tes et vid\xE9os de fond.",
    ...
    },
    {
      ...
      description: "Parcours professionnel et actualit\xE9s.",
      href: "https://www.linkedin.com/in/justine-pegas-3028461b7/",
      icone: "\u{1F4BC}"
    },
    {
      nom: "Calendly",
      handle: "R\xE9server un coaching",
      description: "Prends rendez-vous directement pour une s\xE9ance.",
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactComponent, selectors: [["app-contact"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 12, vars: 0, consts: [[1, "entete-contact"], [1, "badge"], [1, "accent-gold"], [1, "sous-titre"], [1, "grille-reseaux"], ["target", "_blank", "rel", "noopener", 1, "carte-reseau", 3, "href"], [1, "icone-reseau"], [1, "infos-reseau"], [1, "nom-reseau"], [1, "handle-reseau"], [1, "description-reseau"], [1, "fleche-reseau"]], template: function ContactComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, "connect\xE9s.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "p", 3);
      \u0275\u0275text(8, " Une question, envie de r\xE9server une s\xE9ance ou juste envie de suivre l'aventure ? Retrouve-moi sur les r\xE9seaux ci-dessous. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(9, "section", 4);
      \u0275\u0275repeaterCreate(10, ContactComponent_For_11_Template, 12, 5, "a", 5, _forTrack0);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(10);
...
//# sourceMappingURL=chunk-NVBWANZU.js.map
